const indexData = [
  ...
  { year: 2020, project: 'CS Computer Lab energy project', description: "an energy management system for Swarthmore College's computer labs", tools: 'Python, C, Scapy, subprocess, ssh, Grafana, Z Wave', link: 'CS-Energy', media: '/media/CS_Energy/image.png'},
];
...
function createIndexGrid(){
  ...
  indexData.forEach((item, index) => {
    ...
    if (item['media'].toLowerCase().endsWith('.mp4')) {
        ...
        if (item['project'] == 'Trail of Prayers') {
